...
| Blockers | `none` |
| Canonical root | `brand-tokens/clients/stromy/` |
| Scratch root | `brand-tokens/clients/stromy/_build/` |
| Log path | `brand-tokens/clients/stromy/.build-history/BUILD_LOG.md` |
